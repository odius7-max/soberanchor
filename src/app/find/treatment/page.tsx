...
export const metadata: Metadata = { title: 'Treatment Centers — SoberAnchor' }
    ...
    <div className="max-w-[1120px] mx-auto px-6 py-8 pb-20">
      ...
      <div className="mt-5 mb-8">
        ...
        <p className="text-mid text-base leading-relaxed max-w-[560px]">
          Inpatient, residential, and detox programs. Verified listings with real contact information.
        </p>
      </div>

      <FeaturedBand facilityType="treatment" />
      <FacilitiesDirectory facilityType="treatment" savedIds={savedIds} />
    </div>
  )
}
