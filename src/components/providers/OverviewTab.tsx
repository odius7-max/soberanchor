...
export default function OverviewTab({ tier, facilityName, leadsThisMonth, leadsLastMonth, viewsThisMonth, viewsLastMonth, contactClicks, contactClicksLast, recentLeads, onGoToLeads, onGoToPlan }: Props) {
  return (
    <div>
      ...
      {tier === 'basic' && (
        <div style={{ background: 'linear-gradient(135deg, #002244 0%, #1a4a5e 100%)', borderRadius: 14, padding: '28px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 20, marginBottom: 28 }}>
          <div>
