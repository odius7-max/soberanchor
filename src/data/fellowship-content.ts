...
export const FELLOWSHIP_CONTENT: Record<string, FellowshipContent> = {
  ...
  'na': {
    ...
    whatToExpect:
      ...
      'On Medication-Assisted Treatment (MAT) — methadone, buprenorphine (Suboxone), or naltrexone — NA’s official stance has evolved. The fellowship’s literature states that any member taking prescribed medication for a legitimate medical condition can be considered clean. In practice, attitudes vary by region, by meeting, and by individual member. Urban and more progressive meetings are generally welcoming; some older-culture or rural meetings are stricter. If you’re on MAT, ask around or try several meetings to find one that fits.\n\n' +
